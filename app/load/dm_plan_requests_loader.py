...
class DMPLANREQUESTSLoader:
    ...
    def execute(self, execution_date: str = None) -> str:
        ...
        try:
            ...
            # Import datetime and zoneinfo here to avoid circular imports
            from datetime import datetime
            ...
            if execution_date is None:
                ...
                execution_date = datetime.now(ph_tz).strftime("%Y-%m-%d")
...
def execute(execution_date: str = None) -> str:
    """
    Module-level convenience function for Airflow compatibility.
    Delegates to DMPLANREQUESTSLoader.execute().
    """
    loader = DMPLANREQUESTSLoader()
